...
// configura as rotas da route table para redirecionar todo o trafego externo para o InternetGW
resource "aws_route" "private" {
  ...
  // o filtro possibilita vincular N subnets privadas a quantidade fixa de internet gws (3 no cenario atual)
